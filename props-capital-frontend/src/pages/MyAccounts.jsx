  ...
  const filteredAccounts =
    filter === "all"
      ...
      : displayAccounts.filter((a) => {
          ...
          if (filter === "funded")
            return a.status === "funded" || a.current_phase === "funded";
          if (filter === "failed")
            return a.status === "failed" || a.current_phase === "failed";
          return true;
        });
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          {filteredAccounts.map((account) => {
            ...
            return (
              <Card
                key={account.id}
                className={`bg-slate-900 border-slate-800 overflow-hidden ${account.status === "funded" ? "ring-1 ring-amber-500/50" : ""} ${account.status === "failed" ? "opacity-75" : ""}`}
              >
                {/* Header */}
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex justify-between text-sm mb-1">
                        ...
                        <span
                          className={`font-medium ${account.current_profit_percent >= 0 ? "text-emerald-400" : "text-red-400"}`}
                        >
