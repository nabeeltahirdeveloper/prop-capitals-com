...
export default function ChallengeProgress() {
  ...
  const currentProfitTarget =
    currentPhase === "phase2" ? phase2Target : phase1Target;
          ...
          : [
              {
                label: t("challengeProgress.profitTarget"),
                value: `${phase1Target}%`,
                current: t("challengeProgress.passed") || "Passed",
                met: true,
              },
              {
                label: t("challengeProgress.minTradingDays"),
  ...
  const getPhaseProgress = () => {
    ...
    const currentIdx = phaseOrder.indexOf(
      currentPhase === "failed" ? "phase1" : currentPhase,
    );
    ...
    <div className="space-y-6">
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-slate-400">•</span>
                      <span
                        className={`text-xs ${accPhase === "failed" ? "text-red-400" : "text-emerald-400"}`}
                      >
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="text-red-400 font-semibold mb-1">
                {t("challengeProgress.challengeFailed") || "Challenge Failed"}
              </h3>
              <p className="text-slate-400 text-sm">
                {lastViolationMessage ||
                  t("challengeProgress.failedDescription") ||
                  "This challenge has been disqualified due to a rule violation."}
              </p>
              <Link
                to={createPageUrl("TraderBuyChallenge")}
              ...
              >
                ...
                >
                  {t("challengeProgress.startNewChallenge") ||
                    "Start New Challenge"}
                </Button>
              </Link>
            </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
            <div className="flex items-center gap-4">
              <ProgressRing
                progress={Math.max(
                  0,
                  Math.min((profitPercent / currentProfitTarget) * 100, 100),
                )}
                value={profitPercent}
                size={64}
                strokeWidth={5}
                color={
                  profitPercent < 0
                    ? "#ef4444"
                    : profitPercent >= currentProfitTarget
                      ? "#10b981"
                      : "#06b6d4"
                }
      ...
      <Card className="bg-slate-900 border-slate-800 p-6">
        <h3 className="text-lg font-semibold text-white mb-8">
          {t("challengeProgress.yourJourney") || "Your Journey"}
        </h3>
          ...
          {phases.map((phase) => {
            ...
            return (
              ...
              >
                ...
                {/* Step Description */}
                <p
                  className={`text-xs mb-3 ${isLocked ? "text-slate-600" : "text-slate-400"}`}
                >
                  {phase.description}
                </p>
