...
export default function Home() {
  ...
  const challenges = [
    ...
    { size: '$100,000', price: '$499', profit: '8%', split: '85%', popular: true },
  ...
  const testimonials = [
    {
      ...
      quote: 'Got funded within 2 weeks. The process was smooth and payouts are always on time!'
    },
    {
      name: 'Sarah Chen',
      country: '🇬🇧 UK',
      ...
      quote: 'Best prop firm I\'ve worked with. Transparent rules and excellent support team.'
    },
    {
      name: 'Ahmed Hassan',
      country: '🇦🇪 UAE',
      ...
      quote: 'Scaled my account twice already. The profit split is amazing compared to others.'
    }
  ];

  const partners = [
    'MetaTrader', 'cTrader', 'TradingView', 'DXTrade'
  ];
    ...
    <div className="min-h-screen bg-slate-950 overflow-x-hidden">
      ...
      <section className="relative pt-20 sm:pt-24 md:pt-32 pb-16 md:pb-24 overflow-x-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute bottom-1/4 right-0 w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96 bg-cyan-500/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <motion.div
              ...
              variants={stagger}
            >
              <motion.div variants={fadeIn} className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-500/10 border border-emerald-500/20 rounded-full mb-8">
                <Star className="w-4 h-4 text-emerald-400" />
                <span className="text-sm text-emerald-400">{t('home.hero.badge')}</span>
              </motion.div>

              <motion.h1 variants={fadeIn} className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-white mb-4 md:mb-6 leading-tight">
                {t('home.hero.title')}
              ...
              <motion.p variants={fadeIn} className="text-base sm:text-lg md:text-xl text-slate-400 mb-6 md:mb-10">
                {t('home.hero.subtitle')}
              </motion.p>

              <motion.div variants={fadeIn} className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <a href="#challenges">
                  <Button size="lg" className="bg-gradient-to-r from-emerald-500 to-cyan-500 hover:from-emerald-600 hover:to-cyan-600 text-white px-6 sm:px-8 py-4 sm:py-6 text-base sm:text-lg h-auto group w-full sm:w-auto">
                    {t('home.hero.cta')}
                    <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
                  </Button>
                </a>
                <Link to={createPageUrl('HowItWorks')}>
                  <Button size="lg" variant="outline" className="border-slate-600 bg-slate-800/50 text-white hover:bg-slate-700 px-6 sm:px-8 py-4 sm:py-6 text-base sm:text-lg h-auto group w-full sm:w-auto">
              ...
              {/* Trust Badges */}
              <motion.div variants={fadeIn} className="flex items-center gap-6 mt-10">
                <div className="flex items-center gap-2">
                  <BadgeCheck className="w-5 h-5 text-emerald-400" />
                  <span className="text-sm text-slate-400">{t('home.hero.verified')}</span>
                </div>
                <div className="flex items-center gap-2">
                  <Shield className="w-5 h-5 text-emerald-400" />
                  <span className="text-sm text-slate-400">{t('home.hero.secure')}</span>
                </div>
                <div className="flex items-center gap-2">
                  <Headphones className="w-5 h-5 text-emerald-400" />
                  <span className="text-sm text-slate-400">{t('home.hero.support')}</span>
                </div>
              </motion.div>
            </motion.div>
              ...
              <div className="relative">
                ...
                <div className="absolute -left-8 top-1/4 bg-slate-900 border border-slate-800 rounded-xl p-4 shadow-xl">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-xs text-slate-400">{t('home.hero.profitToday')}</p>
                ...
                <div className="absolute -right-8 bottom-1/4 bg-slate-900 border border-slate-800 rounded-xl p-4 shadow-xl">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-xs text-slate-400">{t('home.hero.winRate')}</p>
      ...
      <section className="py-8 md:py-12 border-y border-slate-800 bg-slate-900/50 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center gap-6 md:gap-8">
            <p className="text-slate-400 text-xs sm:text-sm text-center">{t('home.partners.title')}</p>
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 sm:gap-8 md:gap-12 w-full max-w-4xl">
              {partners.map((partner, i) => (
                <div key={i} className="text-slate-500 font-semibold text-sm sm:text-base md:text-lg hover:text-slate-300 transition-colors text-center">
                  {partner}
                </div>
              ))}
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <span className="text-emerald-400 font-semibold text-sm uppercase tracking-wider">{t('home.features.title')}</span>
      ...
      <section className="py-24 bg-slate-900/50 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-16">
            <span className="text-emerald-400 font-semibold text-sm uppercase tracking-wider">{t('home.howItWorks.label')}</span>
                ...
                <Card className="bg-slate-900 border-slate-800 overflow-hidden group hover:border-emerald-500/50 transition-all">
                  <div className="h-48 overflow-hidden relative">
                    ...
                    <div className="absolute bottom-4 left-4">
                      <span className="text-6xl font-bold text-white/20">{item.step}</span>
                    </div>
                  </div>
                  <div className="p-6">
          ...
          <div className="text-center mt-12">
            <Link to={createPageUrl('HowItWorks')}>
              <Button variant="outline" size="lg" className="border-slate-600 bg-slate-800/50 text-white hover:bg-slate-700">
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-emerald-400 font-semibold text-sm uppercase tracking-wider">{t('home.challenges.label')}</span>
            <h2 id="challenges" className="text-3xl md:text-5xl font-bold text-white mt-4 mb-4 scroll-mt-24">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
            {challenges.map((challenge, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <Card className={`relative bg-slate-900 border-slate-800 p-4 sm:p-6 text-center hover:border-emerald-500/50 transition-all hover:-translate-y-2 ${challenge.popular ? 'ring-2 ring-emerald-500' : ''}`}>
                  {challenge.popular && (
                    <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                      <span className="bg-gradient-to-r from-emerald-500 to-cyan-500 text-white text-xs font-bold px-3 py-1 rounded-full flex items-center gap-1">
                        <Star className="w-3 h-3" /> {t('home.challenges.popular')}
                      </span>
                    </div>
                  )}
                  <p className="text-2xl sm:text-3xl font-bold text-white mb-2">{challenge.size}</p>
                  <p className="text-slate-400 mb-4">{t('home.challenges.accountSize')}</p>
                  <div className="space-y-2 mb-6">
                    <div className="flex justify-between text-sm">
                      <span className="text-slate-400">{t('home.challenges.price')}</span>
                      <span className="text-white font-semibold">{challenge.price}</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-slate-400">{t('home.challenges.profitTarget')}</span>
                      <span className="text-white">{challenge.profit}</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-slate-400">{t('home.challenges.profitSplit')}</span>
                      <span className="text-emerald-400 font-semibold">{challenge.split}</span>
                    </div>
                  </div>
                  <Link to={createPageUrl('BuyChallenge') + `?size=${challenge.size.replace(/[^0-9]/g, '')}`}>
                    <Button className={`w-full ${challenge.popular ? 'bg-gradient-to-r from-emerald-500 to-cyan-500 hover:from-emerald-600 hover:to-cyan-600 text-white' : 'bg-slate-800 hover:bg-slate-700 text-white'}`}>
      ...
      <section className="py-24 bg-slate-900/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <span className="text-emerald-400 font-semibold text-sm uppercase tracking-wider">{t('home.testimonials.label')}</span>
            <h2 className="text-3xl md:text-5xl font-bold text-white mt-4 mb-4">
              ...
              >
                <Card className="bg-slate-900 border-slate-800 p-4 sm:p-6 h-full">
                  ...
                  <div className="pt-4 border-t border-slate-800">
                    <p className="text-sm text-slate-400">{t('home.testimonials.totalEarned')}</p>
                    <p className="text-2xl font-bold text-emerald-400">{testimonial.amount}</p>
                  </div>
                </Card>
              </motion.div>
            ))}
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          ...
          >
            ...
            <a href="#challenges">
              <Button size="lg" className="bg-gradient-to-r from-emerald-500 to-cyan-500 hover:from-emerald-600 hover:to-cyan-600 text-white px-8 sm:px-12 py-4 sm:py-6 text-base sm:text-lg h-auto group w-full sm:w-auto">
                {t('home.cta.button')}
                <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </Button>
            </a>
