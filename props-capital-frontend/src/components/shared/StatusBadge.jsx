...
const statusStyles = {
  ...
  phase2: 'bg-purple-500/20 text-purple-400 border-purple-500/30',
  paused: 'bg-amber-500/20 text-amber-400 border-amber-500/30',
  dailylocked: 'bg-red-500/20 text-red-400 border-red-500/30',
  daily_locked: 'bg-red-500/20 text-red-400 border-red-500/30',
