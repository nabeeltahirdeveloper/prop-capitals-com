    ...
    <div className="flex items-center justify-center min-h-[60vh]">
      <div className={`${cardClass} p-8 sm:p-12 text-center max-w-lg w-full`}>
        ...
        <div className="flex items-center justify-center gap-2 mb-4">
          ...
          <span className="text-amber-500 font-semibold text-sm">{t('tradeLockerComingSoon.comingSoon')}</span>
        </div>

        <p className={`text-base mb-8 leading-relaxed ${mutedClass}`}>
          {t('tradeLockerComingSoon.description')}
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          >
            {t('tradeLockerComingSoon.chooseAnotherPlatform')}
          </button>
          <button
          ...
          >
            ...
            {t('tradeLockerComingSoon.backToDashboard')}
          </button>
        </div>
      </div>
    </div>
