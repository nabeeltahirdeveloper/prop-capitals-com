...
export function getInstrumentType(symbol) {
  ...
  const forexPattern =
    /^(EUR|GBP|USD|JPY|AUD|CAD|CHF|NZD|SGD|HKD|NOK|SEK|ZAR|MXN|TRY|PLN|CZK|HUF|DKK|CNH|RUB)\/(EUR|GBP|USD|JPY|AUD|CAD|CHF|NZD|SGD|HKD|NOK|SEK|ZAR|MXN|TRY|PLN|CZK|HUF|DKK|CNH|RUB)$/i;
  const forexPatternNoSlash =
    /^(EUR|GBP|USD|JPY|AUD|CAD|CHF|NZD|SGD|HKD|NOK|SEK|ZAR|MXN|TRY|PLN|CZK|HUF|DKK|CNH|RUB)(EUR|GBP|USD|JPY|AUD|CAD|CHF|NZD|SGD|HKD|NOK|SEK|ZAR|MXN|TRY|PLN|CZK|HUF|DKK|CNH|RUB)$/i;
